...
void PrepScreenSpawnProcBrightenMap(ProcPtr);
...
void PrepScreenSpawnProcMapMenu(struct ProcPrepSallyCursor*);
...
void PrepScreenSpawnProcConfigMenu(ProcPtr);
void PrepScreenSpawnProcShopScreen(ProcPtr);
