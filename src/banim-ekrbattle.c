...
EWRAM_OVERLAY(banim) u32 gDisableEfxQuake = 0;
EWRAM_OVERLAY(banim) u32 gEfxBgSemaphore = 0;
EWRAM_OVERLAY(banim) u32 gBanimHpDrainKind = 0;
EWRAM_OVERLAY(banim) u32 gBanim_Unused_02017754 = 0;
EWRAM_OVERLAY(banim) u32 gBanimTeonoEnd = 0;
EWRAM_OVERLAY(banim) u32 gUnknown_0201775C = 0;
EWRAM_OVERLAY(banim) struct Vec2 gEkrBg2QuakeVec = {0};
EWRAM_OVERLAY(banim) s16 gBanim_Unused_02017764[2] = {0};
EWRAM_OVERLAY(banim) s16 gBanimSpecialEffectDisplayed[2] = {0};
